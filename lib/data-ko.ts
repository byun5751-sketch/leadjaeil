...
export const activitiesKo: Activity[] = [
  {
    ...
    summary:
      "마이크로소프트 AI 커뮤니티가 운영하는 [작은 놀이터]에 연사로 초청받아 진행한 세션입니다. 이미 각자 분야에서 전문성을 갖춘 분들이라 정보가 부족한 게 아니라, 소셜 미디어에 자기를 드러내는 일 자체에 심리적 장벽이 있는 자리였습니다. 그래서 듣기만 하는 강연 대신 이론·사례 50분과 실습·Q&A 30분을 붙인 80분 워크숍으로 설계했습니다.",
    highlights: [
