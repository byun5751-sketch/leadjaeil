...
export const activities: Activity[] = [
  {
    ...
    summary:
      "An invited session at the Microsoft AI Community's \"small playground\" meetup. Everyone in the room was already an expert in their own field, so the gap was not information — it was the discomfort of putting yourself on social media. Rather than a talk to sit through, the session ran as an 80-minute workshop: 50 minutes of theory and examples, then 30 minutes of hands-on work and Q&A.",
    highlights: [
  ...
  },
  {
    ...
    summary:
      "A 90-minute live session titled \"Endless Challenge with LinkedIn\". Profiled the attendees — people balancing a job search with side projects — beforehand, and built the curriculum around turning a career into an asset and connecting it to opportunities, rather than walking through features. The focus was shifting how they saw LinkedIn: not a job board for foreign-invested companies, but a place to record a career and meet people through it.",
    highlights: [
